...
// src/main/frontend/editor/rich-text-schema.js
var annotation = {
  attrs: { id: {} },
  inclusive: true,
  parseDOM: [{
...
var richTextSchema = new Schema({
  ...
  marks: schema.spec.marks.addToEnd("annotation", annotation)
});
function parseRichTextDoc(source) {
  try {
...
// src/main/frontend/editor/rich-text-editor.js
function createRichTextEditor({ mount, initialContent, onChange = () => {
} }) {
